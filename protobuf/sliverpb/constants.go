...
const (
	...
	// MsgRegister - Initial message from CIPHERC2 with metadata
	...
	// MsgKillSessionReq - Kill request to the CIPHERC2 process
	MsgKillSessionReq
	...
	MsgExecuteAssembly
	// MsgInvokeMigrateReq - Spawn a new CIPHERC2 in a designated process
	MsgInvokeMigrateReq
