...
Lets imagine we’re trying to breach a customer we've noticed uses ruby-on-rails for their applications. By default CIPHERC2 will use the following extensions:
