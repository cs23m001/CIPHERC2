...
import { CIPHERC2sIcon } from "@/components/icons/CIPHERC2s";
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center">
              <CIPHERC2sIcon className="mr-2" height={28} />
              <span className="text-2xl">CIPHERC2 Command &amp; Control</span>
            </div>
          </CardHeader>
          <Divider />
          <CardBody>
            ...
            >
              CIPHERC2 is a powerful command and control (C2) framework designed
              to provide advanced capabilities for covertly managing and
              controlling remote systems. With CIPHERC2, security professionals,
        ...
        <div className="grid grid-cols-9 gap-2">
          ...
          <div className="col-span-3">
            <TutorialCard
              ...
              description="How to compile CIPHERC2 from source"
