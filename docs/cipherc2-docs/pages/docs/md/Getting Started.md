Download the latest server [release](https://github.com/cs23m001/cipherc2/releases) for your platform, and just run the binary. That's it, you're pretty much done.
