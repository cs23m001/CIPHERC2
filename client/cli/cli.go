...
const (
	logFileName = "CIPHERC2-client.log"
)
...
func init() {
	...
	// Implant.
	// The implant command allows users to run commands on CIPHERC2 from their
	// system shell. It makes use of pre-runners for connecting to the server
	// and binding CIPHERC2 commands. These same pre-runners are also used for
