...
func implantCmd(con *console.CIPHERC2Client) *cobra.Command {
	con.IsCLI = true

	makeCommands := command.CIPHERC2Commands(con)
	cmd := makeCommands()
...
func makeRunners(implantCmd *cobra.Command, con *console.CIPHERC2Client) (pre, post func(cmd *cobra.Command, args []string) error) {
...
func makeCompleters(cmd *cobra.Command, con *console.CIPHERC2Client) {
