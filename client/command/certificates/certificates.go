...
func CertificateInfoCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func printCertificateInfo(con *console.CIPHERC2Client, certData []*clientpb.CertificateData) {
