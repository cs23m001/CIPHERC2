...
func makeBind(cmd *cobra.Command, con *client.CIPHERC2Client) func(group string, cmds ...func(con *client.CIPHERC2Client) []*cobra.Command) {
	return func(group string, cmds ...func(con *client.CIPHERC2Client) []*cobra.Command) {
		found := false
...
// type commandBinder func(group string, cmds ...func(con *client.CIPHERC2Client) []*cobra.Command)
