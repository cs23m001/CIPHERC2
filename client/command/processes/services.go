...
func ServicesCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	services, err := con.Rpc.Services(context.Background(), &CIPHERC2pb.ServicesReq{
		Hostname: hostname,
...
func ServiceInfoCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
	...
	serviceInfo, err := con.Rpc.ServiceDetail(context.Background(), &CIPHERC2pb.ServiceDetailReq{
		ServiceInfo: &CIPHERC2pb.ServiceInfoReq{Hostname: hostname, ServiceName: serviceName},
		Request:     con.ActiveTarget.Request(cmd),
	})
...
func ServiceStopCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
	...
	stopService, err := con.Rpc.StopService(context.Background(), &CIPHERC2pb.StopServiceReq{
		ServiceInfo: &CIPHERC2pb.ServiceInfoReq{Hostname: hostname, ServiceName: serviceName},
		Request:     con.ActiveTarget.Request(cmd),
	})
...
func ServiceStartCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
	...
	startService, err := con.Rpc.StartServiceByName(context.Background(), &CIPHERC2pb.StartServiceByNameReq{
		ServiceInfo: &CIPHERC2pb.ServiceInfoReq{Hostname: hostname, ServiceName: serviceName},
		Request:     con.ActiveTarget.Request(cmd),
	})
...
func PrintServices(serviceInfo *CIPHERC2pb.Services, con *console.CIPHERC2Client) {
	// Get terminal width
...
func PrintServiceDetail(serviceDetail *CIPHERC2pb.ServiceDetail, con *console.CIPHERC2Client) {
