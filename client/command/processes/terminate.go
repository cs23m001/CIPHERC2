...
func TerminateCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	terminated, err := con.Rpc.Terminate(context.Background(), &CIPHERC2pb.TerminateReq{
...
func PrintTerminate(terminated *CIPHERC2pb.Terminate, con *console.CIPHERC2Client) {
