...
func ProcdumpCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	dump, err := con.Rpc.ProcessDump(context.Background(), &CIPHERC2pb.ProcessDumpReq{
...
func PrintProcessDump(dump *CIPHERC2pb.ProcessDump, saveTo string, hostname string, pid int, con *console.CIPHERC2Client) {
	var err error
...
func LootProcessDump(dump *CIPHERC2pb.ProcessDump, lootName string, hostName string, pid int, con *console.CIPHERC2Client) {
