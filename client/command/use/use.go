...
func UseCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func SessionOrBeaconByID(id string, con *console.CIPHERC2Client) (*clientpb.Session, *clientpb.Beacon, error) {
...
func SelectSessionOrBeacon(con *console.CIPHERC2Client) (*clientpb.Session, *clientpb.Beacon, error) {
...
func BeaconAndSessionIDCompleter(con *console.CIPHERC2Client) carapace.Action {
...
func SessionIDCompleter(con *console.CIPHERC2Client) carapace.Action {
