...
func PortfwdCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	PrintPortfwd(con)
}

// PrintPortfwd - Print the port forward(s).
func PrintPortfwd(con *console.CIPHERC2Client) {
...
func PortfwdIDCompleter(_ *console.CIPHERC2Client) carapace.Action {
