...
func ReconfigCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	reconfig, err := con.Rpc.Reconfigure(context.Background(), &CIPHERC2pb.ReconfigureReq{
