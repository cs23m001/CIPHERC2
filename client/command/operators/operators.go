...
func OperatorsCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func displayOperators(operators []*clientpb.Operator, con *console.CIPHERC2Client) {
	tw := table.NewWriter()
