...
func RegDeleteKeyCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	deleteKey, err := con.Rpc.RegistryDeleteKey(context.Background(), &CIPHERC2pb.RegistryDeleteKeyReq{
		Hive:     hive,
		Path:     finalPath,
		Key:      key,
		Hostname: hostname,
...
func PrintDeleteKey(deleteKey *CIPHERC2pb.RegistryDeleteKey, regPath string, key string, con *console.CIPHERC2Client) {
