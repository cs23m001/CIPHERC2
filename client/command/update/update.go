...
func UpdateCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func VerboseVersionsCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func clientAssetForGOOS(assets []version.Asset) *version.Asset {
	...
	prefix := "CIPHERC2-client"
	return findAssetFor(prefix, suffixes, assets)
}

func updateAvailable(con *console.CIPHERC2Client, client *http.Client, release *version.Release, saveTo string) {
