...
func MakeTokenCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	makeToken, err := con.Rpc.MakeToken(context.Background(), &CIPHERC2pb.MakeTokenReq{
...
func PrintMakeToken(makeToken *CIPHERC2pb.MakeToken, domain string, username string, con *console.CIPHERC2Client) {
