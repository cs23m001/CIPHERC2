...
func GetSystemCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	ctrl := make(chan bool)
	con.SpinUntil("Attempting to create a new CIPHERC2 session as 'NT AUTHORITY\\SYSTEM'...", ctrl)
...
func PrintGetSystem(getsystemResp *CIPHERC2pb.GetSystem, con *console.CIPHERC2Client) {
