...
func RunAsCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	runAs, err := con.Rpc.RunAs(context.Background(), &CIPHERC2pb.RunAsReq{
...
func PrintRunAs(runAs *CIPHERC2pb.RunAs, process string, args string, name string, con *console.CIPHERC2Client) {
