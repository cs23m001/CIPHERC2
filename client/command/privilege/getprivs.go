...
func GetPrivsCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	privs, err := con.Rpc.GetPrivs(context.Background(), &CIPHERC2pb.GetPrivsReq{
...
func PrintGetPrivs(privs *CIPHERC2pb.GetPrivs, pid int32, con *console.CIPHERC2Client) {
...
func updateBeaconIntegrityInformation(con *console.CIPHERC2Client, beaconID string, integrity string) error {
