...
func IfconfigCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
	ifconfig, err := con.Rpc.Ifconfig(context.Background(), &CIPHERC2pb.IfconfigReq{
...
func PrintIfconfig(ifconfig *CIPHERC2pb.Ifconfig, all bool, con *console.CIPHERC2Client) {
	var err error
