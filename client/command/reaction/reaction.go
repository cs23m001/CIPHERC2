...
func ReactionCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	totalReactions := 0
...
func displayReactionsTable(eventType string, reactions []core.Reaction, con *console.CIPHERC2Client) {
	tw := table.NewWriter()
