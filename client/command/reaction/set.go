...
func ReactionSetCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func getEventType(cmd *cobra.Command, con *console.CIPHERC2Client) (string, error) {
...
func selectEventType(con *console.CIPHERC2Client) (string, error) {
