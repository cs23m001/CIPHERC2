...
func CursedEdgeCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func avadaKedavraEdge(session *clientpb.Session, cmd *cobra.Command, con *console.CIPHERC2Client, cargs []string) *core.CursedProcess {
	...
	if edgeProcess != nil {
		...
		con.PrintWarnf("CIPHERC2 will need to kill and restart the Edge process in order to perform code injection.\n")
...
func getEdgeProcess(session *clientpb.Session, cmd *cobra.Command, con *console.CIPHERC2Client) (*commonpb.Process, error) {
