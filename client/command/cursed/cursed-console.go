...
func CursedConsoleCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func selectDebugTarget(targets []overlord.ChromeDebugTarget, con *console.CIPHERC2Client) *overlord.ChromeDebugTarget {
	if len(targets) < 1 {
...
func startCursedConsole(curse *core.CursedProcess, helpers bool, target *overlord.ChromeDebugTarget, con *console.CIPHERC2Client) {
