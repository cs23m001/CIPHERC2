...
func CrackWordlistsCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func CrackRulesCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func CrackHcstat2Cmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func PrintCrackFiles(crackFiles *clientpb.CrackFiles, con *console.CIPHERC2Client) {
	tw := table.NewWriter()
...
func PrintCrackFilesByType(crackFiles *clientpb.CrackFiles, con *console.CIPHERC2Client) {
...
func CrackWordlistsAddCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func CrackRulesAddCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	name, _ := cmd.Flags().GetString("name")
...
func CrackHcstat2AddCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	name, _ := cmd.Flags().GetString("name")
...
func addCrackFile(localFile *os.File, crackFile *clientpb.CrackFile, con *console.CIPHERC2Client) {
	digest := sha256.New()
...
func chunkReader(wordlistReader io.Reader, chunkSize int64, chunks chan []byte) error {
	defer close(chunks)
	start := int64(0)
	tmpFile, err := os.CreateTemp("", "CIPHERC2-wordlist")
	if err != nil {
		return err
	}
	defer tmpFile.Close()
...
func CrackWordlistsRmCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func CrackRulesRmCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func CrackHcstat2RmCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
