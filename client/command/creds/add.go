...
func CredsAddCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
// CredsCmd - Add new credentials.
func CredsAddHashFileCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	collection, _ := cmd.Flags().GetString("collection")
	filePath := args[0]
