...
func CredsCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func PrintCreds(creds []*clientpb.Credential, con *console.CIPHERC2Client) {
...
func printCollection(collection string, creds []*clientpb.Credential, con *console.CIPHERC2Client) {
	tw := table.NewWriter()
...
func CredsHashTypeCompleter(con *console.CIPHERC2Client) carapace.Action {
...
func CredsHashFileFormatCompleter(con *console.CIPHERC2Client) carapace.Action {
...
func CredsCollectionCompleter(con *console.CIPHERC2Client) carapace.Action {
	return carapace.ActionCallback(func(c carapace.Context) carapace.Action {
		results := make([]string, 0)
...
func CredsCredentialIDCompleter(con *console.CIPHERC2Client) carapace.Action {
	return carapace.ActionCallback(func(c carapace.Context) carapace.Action {
		results := make([]string, 0)
