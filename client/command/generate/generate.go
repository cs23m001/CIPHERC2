...
const (
	crossCompilerInfoURL = "https://github.com/cs23m001/CIPHERC2/wiki/Cross-Compiling-Implants"
)
...
func GenerateCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func saveLocation(save, DefaultName string, con *console.CIPHERC2Client) (string, error) {
	var saveTo string
	if save == "" {
		save, _ = os.Getwd()
	}
...
func parseCompileFlags(cmd *cobra.Command, con *console.CIPHERC2Client) (string, *clientpb.ImplantConfig) {
	var name string
...
func parseTrafficEncoderArgs(cmd *cobra.Command, httpC2Enabled bool, con *console.CIPHERC2Client) (bool, []*commonpb.File) {
...
func getTargets(targetOS string, targetArch string, con *console.CIPHERC2Client) (string, string) {
...
func externalBuild(name string, config *clientpb.ImplantConfig, save string, con *console.CIPHERC2Client) (*commonpb.File, error) {
...
func compile(name string, config *clientpb.ImplantConfig, save string, con *console.CIPHERC2Client) (*commonpb.File, error) {
	if config.IsBeacon {
		interval := time.Duration(config.BeaconInterval)
...
func checkBuildTargetCompatibility(format clientpb.OutputFormat, targetOS string, targetArch string, con *console.CIPHERC2Client) bool {
...
func warnMissingCrossCompiler(format clientpb.OutputFormat, targetOS string, targetArch string, con *console.CIPHERC2Client) bool {
...
func findExternalBuilders(config *clientpb.ImplantConfig, con *console.CIPHERC2Client) ([]*clientpb.Builder, error) {
...
func selectExternalBuilder(builders []*clientpb.Builder, _ *console.CIPHERC2Client) (*clientpb.Builder, error) {
	choices := []string{}
