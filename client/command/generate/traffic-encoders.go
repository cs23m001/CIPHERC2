...
func TrafficEncodersCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func DisplayTrafficEncoders(encoderMap *clientpb.TrafficEncoderMap, con *console.CIPHERC2Client) {
	tw := table.NewWriter()
...
func TrafficEncodersAddCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	grpcCtx, cancel := con.GrpcContext(cmd)
	defer cancel()
...
func displayTrafficEncoderTestProgress(testID string, completed chan interface{}, con *console.CIPHERC2Client) {
...
func clearLines(count int, con *console.CIPHERC2Client) {
	for i := 0; i < count; i++ {
...
func displayTrafficEncoderTests(running bool, tests *clientpb.TrafficEncoderTests, con *console.CIPHERC2Client) int {
	tw := table.NewWriter()
	tw.SetStyle(settings.GetTableStyle(con))
	tw.AppendHeader(table.Row{
		"Test",
...
func TrafficEncodersRemoveCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func SelectTrafficEncoder(con *console.CIPHERC2Client) string {
