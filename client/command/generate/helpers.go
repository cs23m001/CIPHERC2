...
// GetCIPHERC2Binary - Get the binary of an implant based on it's profile.
func GetCIPHERC2Binary(profile *clientpb.ImplantProfile, con *console.CIPHERC2Client) ([]byte, error) {
	var data []byte
...
func ArchCompleter(con *console.CIPHERC2Client) carapace.Action {
...
func OSCompleter(con *console.CIPHERC2Client) carapace.Action {
	return carapace.ActionCallback(func(_ carapace.Context) carapace.Action {
		compiler, err := con.Rpc.GetCompiler(context.Background(), &commonpb.Empty{})
		if err != nil {
			return carapace.ActionMessage("No compiler info: %s", err.Error())
...
func HTTPC2Completer(con *console.CIPHERC2Client) carapace.Action {
...
func TrafficEncodersCompleter(con *console.CIPHERC2Client) carapace.Action {
	return carapace.ActionCallback(func(c carapace.Context) carapace.Action {
		grpcCtx, cancel := con.GrpcContext(nil)
		defer cancel()
