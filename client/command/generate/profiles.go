...
func ProfilesCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func PrintProfiles(profiles []*clientpb.ImplantProfile, con *console.CIPHERC2Client) {
	tw := table.NewWriter()
...
func getImplantProfiles(con *console.CIPHERC2Client) []*clientpb.ImplantProfile {
...
func GetImplantProfileByName(name string, con *console.CIPHERC2Client) *clientpb.ImplantProfile {
	pbProfiles, err := con.Rpc.ImplantProfiles(context.Background(), &commonpb.Empty{})
	if err != nil {
		con.PrintErrorf("%s\n", err)
		return nil
...
func PrintProfileInfo(name string, con *console.CIPHERC2Client) {
...
func ProfileNameCompleter(con *console.CIPHERC2Client) carapace.Action {
