...
// GenerateInfoCmd - Display information about the CIPHERC2 server's compiler configuration.
func GenerateInfoCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
