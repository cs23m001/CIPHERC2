...
func MonitorConfigCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func MonitorAddConfigCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func MonitorDelConfigCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func PrintWTConfig(configs *clientpb.MonitoringProviders, con *console.CIPHERC2Client) {
	tw := table.NewWriter()
