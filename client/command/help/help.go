...
// func HelpCmd(con *console.CIPHERC2Console) func(a *grumble.App, shell bool) {
// 	return func(a *grumble.App, shell bool) {
// 		printHelp(con)
// 	}
// }

// func printHelp(con *console.CIPHERC2Console) {
...
// 			if targetOS != "windows" && key == consts.CIPHERC2WinHelpGroup {
// 				continue
// 			}
// 		} else {
// 			if key == consts.CIPHERC2HelpGroup || key == consts.CIPHERC2WinHelpGroup || key == consts.AliasHelpGroup || key == consts.ExtensionHelpGroup {
// 				continue
// 			}
// 		}
// 		if len(key) == 0 {
...
//
// 	con.Println()
// 	con.Printf("For even more information, please see our wiki: https://github.com/BishopFox/CIPHERC2/wiki\n")
// 	con.Println()
// }
//
// func headlinePrinter(c *grumble.Config, con *console.CIPHERC2Console) func(v ...interface{}) (int, error) {
...
// }
//
// func printHeadline(config *grumble.Config, s string, con *console.CIPHERC2Console) {
