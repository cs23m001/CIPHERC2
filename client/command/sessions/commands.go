...
// CIPHERC2Commands returns all session control commands for the active target.
func CIPHERC2Commands(con *console.CIPHERC2Client) []*cobra.Command {
	backgroundCmd := &cobra.Command{
		...
		GroupID: consts.CIPHERC2CoreHelpGroup,
	}
