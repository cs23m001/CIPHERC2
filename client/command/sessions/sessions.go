...
func SessionsCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func PrintSessions(sessions map[string]*clientpb.Session, filter string, filterRegex *regexp.Regexp, con *console.CIPHERC2Client) {
