...
func WebsitesCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	if len(args) > 0 {
		websiteName := args[0]
...
func ListWebsites(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func ListWebsiteContent(websiteName string, con *console.CIPHERC2Client) {
...
func PrintWebsite(web *clientpb.Website, con *console.CIPHERC2Client) {
...
func WebsiteNameCompleter(con *console.CIPHERC2Client) carapace.Action {
