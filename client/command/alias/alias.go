...
func AliasesCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) error {
...
func PrintAliases(con *console.CIPHERC2Client) {
	tw := table.NewWriter()
...
func AliasCommandNameCompleter(prefix string, args []string, con *console.CIPHERC2Client) []string {
	results := []string{}
