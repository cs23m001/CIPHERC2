...
// AliasesRemoveCmd - Locally load a alias into the CIPHERC2 shell.
func AliasesRemoveCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	name := args[0]
...
func RemoveAliasByCommandName(commandName string, con *console.CIPHERC2Client) error {
	if commandName == "" {
