...
func AliasesInstallCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func installFromDir(aliasLocalPath string, con *console.CIPHERC2Client) {
...
func InstallFromFile(aliasGzFilePath string, aliasName string, promptToOverwrite bool, con *console.CIPHERC2Client) *string {
