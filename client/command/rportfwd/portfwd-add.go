...
func StartRportFwdListenerCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	rportfwdListener, err := con.Rpc.StartRportFwdListener(context.Background(), &CIPHERC2pb.RportFwdStartListenerReq{
...
func printStartedRportFwdListener(rportfwdListener *CIPHERC2pb.RportFwdListener, con *console.CIPHERC2Client) {
