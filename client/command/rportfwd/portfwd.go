...
func RportFwdListenersCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	session := con.ActiveTarget.GetSessionInteractive()
	if session == nil {
		return
	}

	rportfwdListeners, err := con.Rpc.GetRportFwdListeners(context.Background(), &CIPHERC2pb.RportFwdListenersReq{
...
func PrintRportFwdListeners(rportfwdListeners *CIPHERC2pb.RportFwdListeners, flags *pflag.FlagSet, con *console.CIPHERC2Client) {
...
func PortfwdIDCompleter(con *console.CIPHERC2Client) carapace.Action {
