...
func StopRportFwdListenerCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	rportfwdListener, err := con.Rpc.StopRportFwdListener(context.Background(), &CIPHERC2pb.RportFwdStopListenerReq{
...
func printStoppedRportFwdListener(rportfwdListener *CIPHERC2pb.RportFwdListener, con *console.CIPHERC2Client) {
