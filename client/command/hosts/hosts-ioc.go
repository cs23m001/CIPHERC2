...
func HostsIOCCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func hostIOCsTable(host *clientpb.Host, con *console.CIPHERC2Client) string {
	tw := table.NewWriter()
...
func SelectHostIOC(host *clientpb.Host, con *console.CIPHERC2Client) (*clientpb.IOC, error) {
