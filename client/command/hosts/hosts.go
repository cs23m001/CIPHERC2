...
func HostsCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func hostsTable(hosts []*clientpb.Host, con *console.CIPHERC2Client) string {
	tw := table.NewWriter()
...
func hostSessions(hostUUID string, con *console.CIPHERC2Client) string {
...
func hostBeacons(hostUUID string, con *console.CIPHERC2Client) string {
...
func SessionsForHost(hostUUID string, con *console.CIPHERC2Client) []*clientpb.Session {
...
func SelectHost(con *console.CIPHERC2Client) (*clientpb.Host, error) {
	allHosts, err := con.Rpc.Hosts(context.Background(), &commonpb.Empty{})
	if err != nil {
		return nil, err
	}
