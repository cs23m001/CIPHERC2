...
func AddLootFile(rpc rpcpb.CIPHERC2RPCClient, name string, fileName string, data []byte, isCredential bool) error {
	if len(data) < 1 {
...
func SelectLoot(cmd *cobra.Command, rpc rpcpb.CIPHERC2RPCClient) (*clientpb.Loot, error) {
