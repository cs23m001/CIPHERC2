...
func LootCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func PrintAllFileLootTable(allLoot *clientpb.AllLoot, con *console.CIPHERC2Client) {
...
func PrintLootFile(loot *clientpb.Loot, con *console.CIPHERC2Client) {
	if loot.File == nil {
		return
	}
	if loot.File.Name != "" {
