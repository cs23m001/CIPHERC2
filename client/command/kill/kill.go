...
func KillCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func KillSession(session *clientpb.Session, cmd *cobra.Command, con *console.CIPHERC2Client) error {
	if session == nil {
...
func KillBeacon(beacon *clientpb.Beacon, cmd *cobra.Command, con *console.CIPHERC2Client) error {
	if beacon == nil {
		return errors.New("session does not exist")
	}
