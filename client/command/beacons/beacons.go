...
func BeaconsCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func PrintBeacons(beacons []*clientpb.Beacon, filter string, filterRegex *regexp.Regexp, con *console.CIPHERC2Client) {
	if len(beacons) == 0 {
...
func renderBeacons(beacons []*clientpb.Beacon, filter string, filterRegex *regexp.Regexp, con *console.CIPHERC2Client) table.Writer {
