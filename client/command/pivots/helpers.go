...
func SelectPivotListener(listeners []*CIPHERC2pb.PivotListener, con *console.CIPHERC2Client) (*CIPHERC2pb.PivotListener, error) {
...
func PivotIDCompleter(con *console.CIPHERC2Client) carapace.Action {
