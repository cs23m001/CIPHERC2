...
func PivotDetailsCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func PrintPivotListenerDetails(listener *CIPHERC2pb.PivotListener, con *console.CIPHERC2Client) {
	con.Printf("\n")
	con.Printf("               ID: %d\n", listener.ID)
