...
func WGSocksStopCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	stopReq, err := con.Rpc.WGStopSocks(context.Background(), &CIPHERC2pb.WGSocksStopReq{
		ID:      int32(socksID),
