...
func WGSocksListCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	socksList, err := con.Rpc.WGListSocksServers(context.Background(), &CIPHERC2pb.WGSocksServersReq{
...
func SocksIDCompleter(con *console.CIPHERC2Client) carapace.Action {
