...
func WGPortFwdAddCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	portfwdAdd, err := con.Rpc.WGStartPortForward(context.Background(), &CIPHERC2pb.WGPortForwardStartReq{
		LocalPort:     localPort,
