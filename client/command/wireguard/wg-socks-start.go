...
func WGSocksStartCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	socks, err := con.Rpc.WGStartSocks(context.Background(), &CIPHERC2pb.WGSocksStartReq{
		Port:    int32(bindPort),
