...
func ExecuteAssemblyCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	execAssembly, err := con.Rpc.ExecuteAssembly(context.Background(), &CIPHERC2pb.ExecuteAssemblyReq{
...
func HandleExecuteAssemblyResponse(execAssembly *CIPHERC2pb.ExecuteAssembly, assemblyPath string, hostName string, cmd *cobra.Command, con *console.CIPHERC2Client) {
