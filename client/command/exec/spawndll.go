...
func SpawnDllCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	spawndll, err := con.Rpc.SpawnDll(context.Background(), &CIPHERC2pb.InvokeSpawnDllReq{
		Data:        binData,
...
func HandleSpawnDLLResponse(spawndll *CIPHERC2pb.SpawnDll, binPath string, hostName string, cmd *cobra.Command, con *console.CIPHERC2Client) {
