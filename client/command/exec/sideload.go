...
func SideloadCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	sideload, err := con.Rpc.Sideload(context.Background(), &CIPHERC2pb.SideloadReq{
...
func HandleSideloadResponse(sideload *CIPHERC2pb.Sideload, binPath string, hostName string, cmd *cobra.Command, con *console.CIPHERC2Client) {
