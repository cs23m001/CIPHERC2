...
func ArmoryUpdateCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func displayAvailableUpdates(con *console.CIPHERC2Client, updateKeys []UpdateIdentifier, aliasUpdates, extensionUpdates map[string]VersionInformation) {
	var (
		aliasSuffix     string
...
func getUpdatesFromUser(con *console.CIPHERC2Client, updateKeys []UpdateIdentifier) (chosenUpdates []UpdateIdentifier, selectionError error) {
