...
func printArmories(con *console.CIPHERC2Client) {
	tw := table.NewWriter()
...
func viewDetailedInformation(con *console.CIPHERC2Client, entity string) {
	tw := table.NewWriter()
	tw.SetStyle(settings.GetTableStyle(con))
...
func ArmoryInfoCommand(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	if len(args) == 0 {
		printArmories(con)
		return
	}
...
func AddArmoryCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func RemoveArmoryCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	name := args[0]
...
func SaveArmories(con *console.CIPHERC2Client) {
	configs := getCurrentArmoryConfiguration()
	err := assets.SaveArmoriesConfig(configs)
	if err != nil {
		con.PrintErrorf("Could not save armory configuration: %s\n", err)
...
func ChangeArmoryEnabledState(cmd *cobra.Command, con *console.CIPHERC2Client, args []string, enabled bool) {
...
func ModifyArmoryCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func RefreshArmories(cmd *cobra.Command, con *console.CIPHERC2Client) {
	clientConfig := parseArmoryHTTPConfig(cmd)
...
func ResetArmoryConfig(cmd *cobra.Command, con *console.CIPHERC2Client) {
