...
func MemfilesListCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}

	memfilesList, err := con.Rpc.MemfilesList(context.Background(), &CIPHERC2pb.MemfilesListReq{
...
// PrintMemfiles - Display an CIPHERC2pb.Ls object.
func PrintMemfiles(ls *CIPHERC2pb.Ls, con *console.CIPHERC2Client) {
