...
func ChtimesCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	chtimes, err := con.Rpc.Chtimes(context.Background(), &CIPHERC2pb.ChtimesReq{
...
func PrintChtimes(chtimes *CIPHERC2pb.Chtimes, con *console.CIPHERC2Client) {
