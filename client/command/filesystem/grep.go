...
import (
	...
	"ggithub.com/cs23m001/CIPHERC2/protobuf/CIPHERC2pb"
...
func GrepCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	grep, err := con.Rpc.Grep(context.Background(), &CIPHERC2pb.GrepReq{
...
func printGrep(grep *CIPHERC2pb.Grep, searchPattern string, searchPath string, cmd *cobra.Command, con *console.CIPHERC2Client) {
...
func grepLineResult(positions []*CIPHERC2pb.GrepLinePosition, line string, colorize bool, allowFormatting bool) string {
	var result string = ""
...
func printGrepResults(results map[string]*CIPHERC2pb.GrepResultsForFile, colorize bool, allowFormatting bool) ([]string, int, []string) {
