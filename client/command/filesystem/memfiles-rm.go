...
func MemfilesRmCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	memfilesList, err := con.Rpc.MemfilesRm(context.Background(), &CIPHERC2pb.MemfilesRmReq{
...
func PrintRmMemfile(memfilesList *CIPHERC2pb.MemfilesRm, con *console.CIPHERC2Client) {
