...
func DownloadCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func HandleDownloadResponse(download *CIPHERC2pb.Download, cmd *cobra.Command, args []string, con *console.CIPHERC2Client) {
	var err error
