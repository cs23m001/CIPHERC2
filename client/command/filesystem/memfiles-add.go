...
func MemfilesAddCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}

	memfilesAdd, err := con.Rpc.MemfilesAdd(context.Background(), &CIPHERC2pb.MemfilesAddReq{
...
func PrintAddMemfile(memfilesAdd *CIPHERC2pb.MemfilesAdd, con *console.CIPHERC2Client) {
