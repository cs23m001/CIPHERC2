...
func RmCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	rm, err := con.Rpc.Rm(context.Background(), &CIPHERC2pb.RmReq{
...
func PrintRm(rm *CIPHERC2pb.Rm, con *console.CIPHERC2Client) {
