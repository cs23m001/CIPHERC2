...
func LsCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
// PrintLs - Display an CIPHERC2pb.Ls object.
func PrintLs(ls *CIPHERC2pb.Ls, flags *pflag.FlagSet, con *console.CIPHERC2Client) {
