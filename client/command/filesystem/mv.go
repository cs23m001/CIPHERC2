...
func MvCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) (err error) {
	...
	mv, err := con.Rpc.Mv(context.Background(), &CIPHERC2pb.MvReq{
...
func PrintMv(mv *CIPHERC2pb.Mv, con *console.CIPHERC2Client) {
