...
func ChownCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	chown, err := con.Rpc.Chown(context.Background(), &CIPHERC2pb.ChownReq{
...
func PrintChown(chown *CIPHERC2pb.Chown, con *console.CIPHERC2Client) {
