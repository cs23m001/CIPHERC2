...
import (
	...
	"github.com/cs23m001/CIPHERC2/implant/CIPHERC2/handlers/matcher"
...
func UploadCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	readFiles := 0
	unreadableFiles := 0
...
func PrintUpload(upload *CIPHERC2pb.Upload, con *console.CIPHERC2Client) {
