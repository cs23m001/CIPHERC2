...
func ChmodCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	chmod, err := con.Rpc.Chmod(context.Background(), &CIPHERC2pb.ChmodReq{
...
func PrintChmod(chmod *CIPHERC2pb.Chmod, con *console.CIPHERC2Client) {
