...
func MountCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
	mount, err := con.Rpc.Mount(context.Background(), &CIPHERC2pb.MountReq{
...
func PrintMount(os string, mount *CIPHERC2pb.Mount, con *console.CIPHERC2Client) {
...
func mountRow(os string, mountInfo *CIPHERC2pb.MountInfo) table.Row {
	var row table.Row
