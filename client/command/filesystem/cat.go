...
func CatCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func PrintCat(originalFileName string, download *CIPHERC2pb.Download, cmd *cobra.Command, con *console.CIPHERC2Client) {
	var (
...
func colorize(f *CIPHERC2pb.Download) error {
