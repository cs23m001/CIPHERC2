...
func CpCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) (err error) {
	...
	cp, err := con.Rpc.Cp(context.Background(), &CIPHERC2pb.CpReq{
...
func PrintCp(cp *CIPHERC2pb.Cp, con *console.CIPHERC2Client) {
