...
import (
	...
	"github.com/cs23m001/CIPHERC2/client/command/armory"
	"github.com/cs23m001/CIPHERC2/client/command/beacons"
	"github.com/cs23m001/CIPHERC2/client/command/builders"
	"github.com/cs23m001/CIPHERC2/client/command/c2profiles"
	"github.com/cs23m001/CIPHERC2/client/command/certificates"
	"github.com/cs23m001/CIPHERC2/client/command/clean"
	"github.com/cs23m001/CIPHERC2/client/command/crack"
	"github.com/cs23m001/CIPHERC2/client/command/creds"
	"github.com/cs23m001/CIPHERC2/client/command/exit"
	"github.com/cs23m001/CIPHERC2/client/command/generate"
	"github.com/cs23m001/CIPHERC2/client/command/hosts"
	"github.com/cs23m001/CIPHERC2/client/command/info"
	"github.com/cs23m001/CIPHERC2/client/command/jobs"
	"github.com/cs23m001/CIPHERC2/client/command/licenses"
	"github.com/cs23m001/CIPHERC2/client/command/loot"
	"github.com/cs23m001/CIPHERC2/client/command/monitor"
	"github.com/cs23m001/CIPHERC2/client/command/operators"
	"github.com/cs23m001/CIPHERC2/client/command/reaction"
	"github.com/cs23m001/CIPHERC2/client/command/sessions"
	"github.com/cs23m001/CIPHERC2/client/command/settings"
	sgn "github.com/cs23m001/CIPHERC2/client/command/shikata-ga-nai"
	"github.com/cs23m001/CIPHERC2/client/command/socks"
	"github.com/cs23m001/CIPHERC2/client/command/taskmany"
	"github.com/cs23m001/CIPHERC2/client/command/update"
	"github.com/cs23m001/CIPHERC2/client/command/use"
	"github.com/cs23m001/CIPHERC2/client/command/websites"
...
func ServerCommands(con *client.CIPHERC2Client, serverCmds func() []*cobra.Command) console.Commands {
	serverCommands := func() *cobra.Command {
		...
		// the CIPHERC2 menu: call the function with the name of the
