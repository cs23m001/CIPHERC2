...
func Command(con *console.CIPHERC2Client) []*cobra.Command {
	...
	// for _, c := range CIPHERC2Commands(con)().Commands() {
...
func TaskmanyCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func WrapCommand(c *cobra.Command, con *console.CIPHERC2Client) *cobra.Command {
	wc := &cobra.Command{
		Use:   c.Use,
		Short: c.Short,
		Long:  c.Long,
...
func wrapFunctionWithTaskmany(con *console.CIPHERC2Client, f func(cmd *cobra.Command, args []string)) func(cmd *cobra.Command, args []string) {
...
func SelectMultipleBeaconsAndSessions(con *console.CIPHERC2Client) ([]*clientpb.Session, []*clientpb.Beacon, error) {
