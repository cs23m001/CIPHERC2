...
func ScreenshotCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	...
	screenshot, err := con.Rpc.Screenshot(context.Background(), &CIPHERC2pb.ScreenshotReq{
...
func PrintScreenshot(screenshot *CIPHERC2pb.Screenshot, hostname string, cmd *cobra.Command, con *console.CIPHERC2Client) {
...
func LootScreenshot(screenshot *CIPHERC2pb.Screenshot, lootName string, hostName string, con *console.CIPHERC2Client) {
