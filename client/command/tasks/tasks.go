...
func TasksCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func PrintBeaconTasks(tasks []*clientpb.BeaconTask, cmd *cobra.Command, con *console.CIPHERC2Client) {
	tw := table.NewWriter()
