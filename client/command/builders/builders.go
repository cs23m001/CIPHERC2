...
func BuildersCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func PrintBuilders(externalBuilders []*clientpb.Builder, con *console.CIPHERC2Client) {
	tw := table.NewWriter()
