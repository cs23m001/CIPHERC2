...
var (
	tableStyles = map[string]table.Style{
		// CIPHERC2 styles
		CIPHERC2Default.Name: CIPHERC2Default,
	...
	CIPHERC2Default = table.Style{
		Name: "CIPHERC2Default",
		Box: table.BoxStyle{
			BottomLeft:       " ",
			BottomRight:      " ",
			BottomSeparator:  " ",
	...
	CIPHERC2BordersDefault = table.Style{
		Name: "CIPHERC2BordersDefault",
		Box: table.BoxStyle{
			BottomLeft:       "+",
			BottomRight:      "+",
			BottomSeparator:  "-",
...
func GetTableStyle(con *console.CIPHERC2Client) table.Style {
	if con.Settings == nil {
	...
	return tableStyles[CIPHERC2Default.Name]
}

// GetTableWithBordersStyle - Get the table style with borders.
func GetTableWithBordersStyle(con *console.CIPHERC2Client) table.Style {
	if con.Settings == nil {
		con.Settings, _ = assets.LoadSettings()
	}
	value, ok := tableStyles[con.Settings.TableStyle]
	if !ok || con.Settings.TableStyle == CIPHERC2Default.Name {
		return CIPHERC2BordersDefault
	}
	return value
}
...
func PaginateTable(tw table.Writer, skipPages int, overflow bool, interactive bool, con *console.CIPHERC2Client) {
