...
func SettingsCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	var err error
	if con.Settings == nil {
...
func SettingsAlwaysOverflow(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	var err error
	if con.Settings == nil {
		con.Settings, err = assets.LoadSettings()
		if err != nil {
...
func SettingsConsoleLogs(cmd *cobra.Command, con *console.CIPHERC2Client) {
	var err error
	if con.Settings == nil {
		con.Settings, err = assets.LoadSettings()
		if err != nil {
...
func SettingsSmallTerm(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	var err error
	if con.Settings == nil {
		con.Settings, err = assets.LoadSettings()
		if err != nil {
...
func SettingsTablesCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	var err error
	if con.Settings == nil {
		con.Settings, err = assets.LoadSettings()
		if err != nil {
...
func SettingsSaveCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	var err error
	if con.Settings == nil {
		con.Settings, err = assets.LoadSettings()
		if err != nil {
...
// SettingsAlwaysOverflow - Toggle always overflow.
func SettingsUserConnect(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	var err error
	if con.Settings == nil {
		con.Settings, err = assets.LoadSettings()
		if err != nil {
