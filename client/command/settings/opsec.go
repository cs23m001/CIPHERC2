...
func SettingsAutoAdultCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	var err error
	if con.Settings == nil {
...
func IsUserAnAdult(con *console.CIPHERC2Client) bool {
	if GetAutoAdult(con) {
		return true
	}
	confirm := false
...
func GetAutoAdult(con *console.CIPHERC2Client) bool {
	if con.Settings == nil {
