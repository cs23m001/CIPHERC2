...
func ExtensionsInstallCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
	extLocalPath := args[0]
...
func InstallFromDir(extLocalPath string, promptToOverwrite bool, con *console.CIPHERC2Client, isGz bool) {
