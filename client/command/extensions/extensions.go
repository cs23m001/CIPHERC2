...
func ExtensionsCmd(cmd *cobra.Command, con *console.CIPHERC2Client) {
...
func PrintExtensions(con *console.CIPHERC2Client) {
	tw := table.NewWriter()
...
func ExtensionsCommandNameCompleter(con *console.CIPHERC2Client) carapace.Action {
