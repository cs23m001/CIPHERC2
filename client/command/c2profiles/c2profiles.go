...
func C2ProfileCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func ImportC2ProfileCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func ExportC2ProfileCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func GenerateC2ProfileCmd(cmd *cobra.Command, con *console.CIPHERC2Client, args []string) {
...
func PrintC2Profiles(profile *clientpb.HTTPC2Config, con *console.CIPHERC2Client) {
