...
// MTLSConnect - Connect to the CIPHERC2 server
func MTLSConnect(config *assets.ClientConfig) (rpcpb.CIPHERC2RPCClient, *grpc.ClientConn, error) {
	...
	return rpcpb.NewCIPHERC2RPCClient(connection), connection, nil
}
