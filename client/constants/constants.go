...
const (
	...
	// ConnectedEvent - CIPHERC2 Connected.
	SessionOpenedEvent = "session-connected"
	// DisconnectedEvent - CIPHERC2 disconnected.
	SessionClosedEvent = "session-disconnected"
	// UpdateEvent - CIPHERC2 updated.
...
const (
	...
	DataHelpGroup     = "Data"
	CIPHERC2HelpGroup = "CIPHERC2"

	// CIPHERC2 commands =====================.
	CIPHERC2CoreHelpGroup = "Core"
	InfoHelpGroup         = "Info"
	...
	AliasHelpGroup     = "CIPHERC2 - 3rd Party macros"
	ExtensionHelpGroup = "CIPHERC2 - 3rd Party extensions"

	// Useless.
	CIPHERC2WinHelpGroup = "CIPHERC2 - Windows"
