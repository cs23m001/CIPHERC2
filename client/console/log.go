...
type ConsoleClientLogger struct {
	name   string
	Stream rpcpb.CIPHERC2RPC_ClientLogClient
}
...
func (con *CIPHERC2Client) ClientLogStream(name string) (*ConsoleClientLogger, error) {
...
func (con *CIPHERC2Client) setupLogger(writers ...io.Writer) {
...
func (con *CIPHERC2Client) logCommand(args []string) ([]string, error) {
	if len(args) == 0 {
		return args, nil
	}
...
func (con *CIPHERC2Client) setupAsciicastRecord(logFile *os.File, server io.Writer) {
...
func (con *CIPHERC2Client) PrintAsyncResponse(resp *commonpb.Response) {
...
func (con *CIPHERC2Client) Printf(format string, args ...any) {
...
func (con *CIPHERC2Client) Println(args ...any) {
...
func (con *CIPHERC2Client) PrintInfof(format string, args ...any) {
	logger := slog.New(con.jsonHandler)
...
func (con *CIPHERC2Client) PrintSuccessf(format string, args ...any) {
	logger := slog.New(con.jsonHandler)
...
func (con *CIPHERC2Client) PrintWarnf(format string, args ...any) {
	logger := slog.New(con.jsonHandler)
...
func (con *CIPHERC2Client) PrintErrorf(format string, args ...any) {
	logger := slog.New(con.jsonHandler)
...
func (con *CIPHERC2Client) PrintEventInfof(format string, args ...any) {
...
func (con *CIPHERC2Client) PrintEventErrorf(format string, args ...any) {
	logger := slog.New(con.jsonHandler).With(slog.String("type", "event"))
...
func (con *CIPHERC2Client) PrintEventSuccessf(format string, args ...any) {
	logger := slog.New(con.jsonHandler).With(slog.String("type", "event"))
