...
func StartDNSListener(bindIface string, lport uint16, domains []string, canaries bool, enforceOTP bool) *CIPHERC2DNSServer {
	// StartPivotListener()
	server := &CIPHERC2DNSServer{
...
func (s *DNSSession) StageOutgoingEnvelope(envelope *CIPHERC2pb.Envelope) error {
...
// CIPHERC2DNSServer - DNS server implementation
type CIPHERC2DNSServer struct {
	server       *dns.Server
	sessions     *sync.Map
	messages     *sync.Map
	TTL          uint32
...
func (s *CIPHERC2DNSServer) Shutdown() error {
	return s.server.Shutdown()
}

// ListenAndServe - Listen for DNS requests and respond
func (s *CIPHERC2DNSServer) ListenAndServe() error {
...
func (s *CIPHERC2DNSServer) HandleDNSRequest(domains []string, canaries bool, writer dns.ResponseWriter, req *dns.Msg) {
	if req == nil {
...
func (s *CIPHERC2DNSServer) isC2SubDomain(domains []string, reqDomain string) (bool, string) {
...
func (s *CIPHERC2DNSServer) handleC2(domain string, req *dns.Msg) *dns.Msg {
...
func (s *CIPHERC2DNSServer) decodeSubdata(subdomain string) (*dnspb.DNSMessage, uint32, error) {
...
func (s *CIPHERC2DNSServer) determineLikelyEncoders(subdata string) []encoders.Encoder {
...
func (s *CIPHERC2DNSServer) nameErrorResp(req *dns.Msg) *dns.Msg {
	resp := new(dns.Msg)
...
func (s *CIPHERC2DNSServer) refusedErrorResp(req *dns.Msg) *dns.Msg {
	resp := new(dns.Msg)
...
// ---------------------------
func (s *CIPHERC2DNSServer) handleHello(domain string, msg *dnspb.DNSMessage, req *dns.Msg) *dns.Msg {
...
func (s *CIPHERC2DNSServer) handleDNSSessionInit(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *CIPHERC2DNSServer) handlePoll(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *CIPHERC2DNSServer) handleDataFromImplant(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *CIPHERC2DNSServer) handleDataToImplant(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *CIPHERC2DNSServer) handleClear(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *CIPHERC2DNSServer) handleNOP(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *CIPHERC2DNSServer) handleCanary(req *dns.Msg) *dns.Msg {
