...
import (
	...
	clientAssets "github.com/cs23m001/CIPHERC2/client/assets"
	...
	"github.com/cs23m001/CIPHERC2/server/builder"
...
var builderCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		builderLog.Infof("Initializing CIPHERC2 external builder - %s", version.FullVersion())
...
func createBuilder(cmd *cobra.Command, configPath string, mutex *sync.Mutex) (*builder.Builder, error) {
	...
	externalBuilder.Templates = []string{"CIPHERC2"}
