...
func beaconRegisterHandler(implantConn *core.ImplantConnection, data []byte) *CIPHERC2pb.Envelope {
	beaconReg := &CIPHERC2pb.BeaconRegister{}
...
func auditLogBeacon(beacon *models.Beacon, register *CIPHERC2pb.Register) {
...
func beaconTasksHandler(implantConn *core.ImplantConnection, data []byte) *CIPHERC2pb.Envelope {
	beaconTasks := &CIPHERC2pb.BeaconTasks{}
	...
	taskData, err := proto.Marshal(&CIPHERC2pb.BeaconTasks{Tasks: tasks})
	if err != nil {
	...
	return &CIPHERC2pb.Envelope{
		Type: CIPHERC2pb.MsgBeaconTasks,
		Data: taskData,
	}
}

func beaconTaskResults(beaconID string, taskEnvelopes []*CIPHERC2pb.Envelope) *CIPHERC2pb.Envelope {
