...
func TestCIPHERC2ExecutableWindows(t *testing.T) {
...
func TestCIPHERC2SharedLibWindows(t *testing.T) {
	// amd64
...
func TestCIPHERC2ExecutableLinux(t *testing.T) {
	// amd64
...
func TestCIPHERC2SharedLibraryLinux(t *testing.T) {
	// amd64
...
func TestCIPHERC2ExecutableDarwin(t *testing.T) {
	// amd64
...
func TestCIPHERC2DefaultBuild(t *testing.T) {
...
func trafficEncodersExecutable(t *testing.T, goos string, goarch string) {
	...
	nonce++
	_, err := CIPHERC2Executable(name, build, debugConfig, debugHttpC2Config.ImplantConfig)
	if err != nil {
		t.Fatalf("%v", err)
	}
	...
	nonce++
	_, err = CIPHERC2Executable(name, build, prodConfig, debugHttpC2Config.ImplantConfig)
	if err != nil {
		t.Fatalf("%v", err)
	}
}
...
func mtlsExe(t *testing.T, goos string, goarch string, beacon bool, debug bool) {
	...
	nonce++
	_, err := CIPHERC2Executable(name, build, config, httpC2Config.ImplantConfig)
	if err != nil {
		t.Fatalf("%v", err)
	}
}
...
func multiLibrary(t *testing.T, goos string, goarch string, debug bool) {
	...
	nonce++
	build, _ := GenerateConfig(name, config)
	_, err := CIPHERC2SharedLibrary(name, build, config, httpC2Config.ImplantConfig)
	if err != nil {
		t.Fatalf("%v", err)
	}
}
