...
// CIPHERC2External - Generates the cryptographic keys for the implant but compiles no code
func CIPHERC2External(name string, config *clientpb.ImplantConfig) (*clientpb.ExternalImplantConfig, error) {
