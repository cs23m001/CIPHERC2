...
This directory contains the CIPHERC2 server implementation, and is structured as follows:
 ...
 * `console/` - Server specific console code, the majority of the CIPHERC2 console code is in `/client/console`
