...
func GetRootAppDir() string {
	...
	if _, err := os.Stat(dir); os.IsNotExist(err) {
		...
		if err != nil {
			setupLog.Fatalf("Cannot write to CIPHERC2 root dir %s", err)
		}
	}
	return dir
}
...
// GetChunkDataDir - Get the CIPHERC2 chunk data dir, default is: ~/.CIPHERC2/crack/chunks/
...
// GetTrafficEncoderDir - Get the CIPHERC2 traffic encoder dir, default is: ~/.CIPHERC2/traffic-encoders/
...
func GetGPGPublicKey() (*packet.PublicKey, error) {
	rawPublicKey, err := assetsFs.ReadFile("fs/CIPHERC2.asc")
	if err != nil {
		return nil, err
	}
