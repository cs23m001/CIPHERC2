...
func (rpc *Server) PivotSessionListeners(ctx context.Context, req *CIPHERC2pb.PivotListenersReq) (*CIPHERC2pb.PivotListeners, error) {
	resp := &CIPHERC2pb.PivotListeners{Response: &commonpb.Response{}}
...
func (rpc *Server) PivotStartListener(ctx context.Context, req *CIPHERC2pb.PivotStartListenerReq) (*CIPHERC2pb.PivotListener, error) {
	resp := &CIPHERC2pb.PivotListener{Response: &commonpb.Response{}}
	err := rpc.GenericHandler(req, resp)
	if err != nil {
		return nil, err
	}
...
func (rpc *Server) PivotStopListener(ctx context.Context, req *CIPHERC2pb.PivotStopListenerReq) (*commonpb.Empty, error) {
	resp := &CIPHERC2pb.PivotListener{Response: &commonpb.Response{}}
	err := rpc.GenericHandler(req, resp)
	if err != nil {
		return nil, err
