...
func (rpc *Server) Screenshot(ctx context.Context, req *CIPHERC2pb.ScreenshotReq) (*CIPHERC2pb.Screenshot, error) {
	resp := &CIPHERC2pb.Screenshot{Response: &commonpb.Response{}}
