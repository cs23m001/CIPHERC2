...
import (
	...
	"github.com/cs23m001/CIPHERC2/server/msf"
)
...
func (rpc *Server) Msf(ctx context.Context, req *clientpb.MSFReq) (*CIPHERC2pb.Task, error) {
	var os string
	var arch string
...
func (rpc *Server) MsfRemote(ctx context.Context, req *clientpb.MSFRemoteReq) (*CIPHERC2pb.Task, error) {
	var os string
	var arch string
	if !req.Request.Async {
		session := core.Sessions.Get(req.Request.SessionID)
