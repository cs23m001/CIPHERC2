...
func (rpc *Server) Reconfigure(ctx context.Context, req *CIPHERC2pb.ReconfigureReq) (*CIPHERC2pb.Reconfigure, error) {
	...
	resp := &CIPHERC2pb.Reconfigure{Response: &commonpb.Response{}}
