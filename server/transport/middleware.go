...
var (
	...
	builderMethods = map[string]bool{
		"/rpcpb.CIPHERC2RPC/GetVersion": true,

		"/rpcpb.CIPHERC2RPC/GenerateExternalGetBuildConfig": true,
		"/rpcpb.CIPHERC2RPC/GenerateExternalSaveBuild":      true,
		"/rpcpb.CIPHERC2RPC/BuilderRegister":                true,
		"/rpcpb.CIPHERC2RPC/BuilderTrigger":                 true,
		"/rpcpb.CIPHERC2RPC/Builders":                       true,
	}
	// Crackstation - Allowed methods
	crackstationMethods = map[string]bool{
		"/rpcpb.CIPHERC2RPC/GetVersion": true,

		"/rpcpb.CIPHERC2RPC/CrackstationRegister":   true,
		"/rpcpb.CIPHERC2RPC/CrackstationTrigger":    true,
		"/rpcpb.CIPHERC2RPC/CrackstationBenchmark":  true,
		"/rpcpb.CIPHERC2RPC/Crackstations":          true,
		"/rpcpb.CIPHERC2RPC/CrackTaskByID":          true,
		"/rpcpb.CIPHERC2RPC/CrackTaskUpdate":        true,
		"/rpcpb.CIPHERC2RPC/CrackFilesList":         true,
		"/rpcpb.CIPHERC2RPC/CrackFileCreate":        true,
		"/rpcpb.CIPHERC2RPC/CrackFileChunkUpload":   true,
		"/rpcpb.CIPHERC2RPC/CrackFileChunkDownload": true,
		"/rpcpb.CIPHERC2RPC/CrackFileComplete":      true,
		"/rpcpb.CIPHERC2RPC/CrackFileDelete":        true,
	}
)
